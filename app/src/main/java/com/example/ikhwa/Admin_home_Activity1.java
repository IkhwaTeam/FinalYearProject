...
public class Admin_home_Activity1 extends AppCompatActivity {

    private TextView courseBtn, teacherBtn, studentBtn, notificationBtn,studetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studetails=findViewById(R.id.student_details);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Admin_home_Activity1.this, "Failed: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });


        courseBtn.setOnClickListener(view -> {
            Intent intent = new Intent(Admin_home_Activity1.this, CourseActivity.class);
            startActivity(intent);
        });

        teacherBtn.setOnClickListener(view -> {
            Intent intent = new Intent(Admin_home_Activity1.this, PendingTeachersActivity.class);
            startActivity(intent);
        });
        ...
        studentBtn.setOnClickListener(view -> {
            Intent intent = new Intent(Admin_home_Activity1.this, Approve_Rejected_Activity1.class);
            startActivity(intent);
        });

        notificationBtn.setOnClickListener(view -> {
            Intent intent = new Intent(Admin_home_Activity1.this, Admin_Notification_Activity1.class);
            startActivity(intent);
        });
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Admin_home_Activity1.this, SelectionActivity.class);
